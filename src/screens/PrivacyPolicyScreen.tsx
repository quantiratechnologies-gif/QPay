...
import { privacyDocumentEn } from '../content/privacy.en';
import { privacyDocumentAr } from '../content/privacy.ar';
import { Lock } from 'lucide-react';

export const PrivacyPolicyScreen: React.FC = () => {
  const { language, isRtl } = useApp();
  const doc = language === 'العربية' ? privacyDocumentAr : privacyDocumentEn;
