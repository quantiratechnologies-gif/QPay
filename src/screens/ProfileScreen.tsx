...
export const ProfileScreen: React.FC = () => {
  ...
  return (
    <div className="fade-in" style={{ backgroundColor: '#080c14', minHeight: '100%', paddingBottom: '96px' }}>
      {showToast && (
        <div className="fade-in" style={{ position: 'fixed', top: '24px', left: '50%', transform: 'translateX(-50%)', zIndex: 9999, backgroundColor: 'rgba(127, 232, 127, 0.16)', border: '1px solid #7FE87F', color: '#7FE87F', padding: '10px 18px', borderRadius: '30px', fontWeight: 800, fontSize: '13px', display: 'flex', alignItems: 'center', gap: '8px', backdropFilter: 'blur(8px)' }}>
        ...
        <div>
          ...
          <div style={{ backgroundColor: '#111726', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: '18px', overflow: 'hidden', padding: 0, boxShadow: 'none' }}>
            <ListRow
              ...
              label={language === 'العربية' ? 'الهوية الوطنية / إعادة التوثيق (KYC)' : 'National ID & KYC'}
              rightElement={
                <span style={{ fontSize: '11px', fontWeight: 800, color: isKycVerified ? '#7FE87F' : '#FFB300' }}>
                  {isKycVerified
                    ? (language === 'العربية' ? 'موثق • إعادة التوثيق' : 'Verified • KYC')
